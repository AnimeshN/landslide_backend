...
class descisionTree(APIView):
    def get(self,*args,**kwargs):
            ...
            val2 = self.kwargs.get('RochChar', None)
            ...
            Style = int(PredictorConfig.le_Style.transform([val10])[0])
            
            #predicting value
            result = PredictorConfig.model.predict([[Geomorphology,RochChar,OverburdenThickness,Hydrology,Erosion,Rainfall,Anthropogenic,SlopeType,LandslideMaterial,Movement,Style]])
